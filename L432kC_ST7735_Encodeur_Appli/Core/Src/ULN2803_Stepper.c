...
void Stepper_Init(StepperMotor *motor) {
	...
	motor->motorPin[0] = MOTOR_COIL1_PIN_1; //Blue
	motor->motorPin[1] = MOTOR_COIL1_PIN_2; //Yellow
	motor->motorPin[2] = MOTOR_COIL2_PIN_3; //Pink
	motor->motorPin[3] = MOTOR_COIL2_PIN_4; //Orange
