...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = ENOCDER_IN2_D9_Pin|ENCODER_IN1_D1_Pin;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM16_MspPostInit 0 */
    ...
    PA6     ------> TIM16_CH1
    */
    GPIO_InitStruct.Pin = RGB_Pixel_Led_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF14_TIM16;
    HAL_GPIO_Init(RGB_Pixel_Led_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, ENOCDER_IN2_D9_Pin|ENCODER_IN1_D1_Pin);
