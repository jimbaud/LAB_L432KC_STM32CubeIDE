...
// ========================
extern TIM_HandleTypeDef htim1;           // Déclaration globale du Timer
extern DMA_HandleTypeDef hdma_tim1_ch1;   // Déclaration globale du DMA

// Définir globalement le timer et le canal utilisés
#define HTIM                htim1           // Choisissez le timer (htim1, htim2, etc.) suivant la déclaration globale du Timer
#define DMA_CHANNEL         hdma_tim1_ch1   // Choisissez le canal DMA associé suivant la déclaration globale du DMA
